...
7. **噶瑪蘭族**（Kavalan）— 宜蘭南遷族群，臺東主要分布於長濱鄉三間村、樟原村、大峰峰等聚落；常被引用的「約 113 人」是**臺東縣（非長濱鄉）** 2002 年 6–8 月自我認同調查的縣層級數字（全國同期約 1,500 餘人），已是二十餘年前的統計，非現況人口。花蓮豐濱鄉新社、立德是噶瑪蘭族文化保存最完整、人口最集中的聚落，臺東為次要分布地（見 `ops/JOURNAL/2026-08-06.md` F1、`ops/BACKLOG.md` B-004；`ops/JOURNAL/2026-08-08.md` F7 對聚落分布有更完整的查證紀錄）
